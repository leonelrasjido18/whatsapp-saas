...
import { joinWaitlistTool } from "./tools/join_waitlist";
import { getLoyaltyPointsTool } from "./tools/get_loyalty_points";
import { createQuoteTool } from "./tools/create_quote";
import { createRecurringOrderTool } from "./tools/create_recurring_order";
...
registry.register(getLoyaltyPointsTool);
registry.register(createQuoteTool);
registry.register(createRecurringOrderTool);
