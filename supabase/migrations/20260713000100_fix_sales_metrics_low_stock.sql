-- ============================================================
-- Fix get_sales_metrics: la consulta de stock bajo referenciaba columnas
-- inexistentes (products.track_stock / products.stock). La tabla products usa
-- type='product', stock_qty y low_stock_threshold. Esto hacía fallar toda la
-- RPC → "Error al cargar balances" en Ventas → Balances.
-- Solo cambia el bloque 6 (stock bajo); el resto queda igual.
-- ============================================================
...
BEGIN
  ...
  -- 6. Productos con stock bajo (solo productos con stock gestionado)
  SELECT COUNT(*)
